  ...
  render() {
      ...
      plotOptions: {
          pie: {
              ...
              dataLabels: {
                  ...
                  style: {
                      color: (ReactHighChart.Highcharts.theme && ReactHighChart.Highcharts.theme.contrastTextColor) || 'black'
                  }
              }
          }
      },
    ...
    const config5 = {
      ...
      series: [{
        ...
        colorByPoint: true,
        data: [{
            name: itemsForPie[0].platform,
            y: itemsForPie[0].trafficPercentage
        }, {
            name: itemsForPie[1].platform,
            y: itemsForPie[1].trafficPercentage,
            sliced: true,
            selected: true
        }, {
            name: itemsForPie[2].platform,
            y: itemsForPie[2].trafficPercentage
        },]
      }]
    }
    ...
    return(
      <div>
        ...
        <div>
          ...
          {console.log(itemsForPie)}
        </div>
        <ul>
          {items}
        </ul>
        <ReactHighChart config={config} />
        <ReactHighChart config={config2} />
        <ReactHighstock config={config3} />
        <ReactHighChart config={config4} /> {/* I can just pass in any configuration object to ReactHighChart */}
        <ReactHighChart config={config3} /> {/* missing features for this chart NO GOOD */}
        <ReactHighChart config={config5} />
      </div>
    );
  }
}
